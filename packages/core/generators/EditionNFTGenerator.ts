...
export class EditionNFTGenerator extends TemplateGenerator {
  ...
  static deploy(): string {
    return this.generate(require('../../../cadence/nfts/edition-nft/transactions/deploy.cdc'));
  }
  ...
  static getEditionsByHash({
    ...
    return this.generate(require('../../../cadence/nfts/edition-nft/scripts/get_editions_by_hash.template.cdc'), {
      contractName,
      contractAddress,
    });
  }
