...
The following is a set of guidelines for contributing to Freshmint.
...
- **What is the version of the Freshmint you're using**?
...
Unsure where to begin contributing to Freshmint?
You can start by looking through these "Good first issue" and "Help wanted" issues:

- [Good first issues](https://github.com/onflow/freshmint/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/onflow/freshmint/labels/help%20wanted):
...
Thank you for your interest in contributing to Freshmint!
